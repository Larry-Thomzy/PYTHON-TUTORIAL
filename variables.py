...
# create a program for missle specifications
# missle name (string)
# missle range in kilometers (int)
# missle speed in Mach (float)
...
# is currently on active duty (bool)

# Jet fighter loadout
#jet model (string)
#number of missiles loaded (int)
#fuel level in liters (float)
#radar system active (bool)
...
# is turret operational (bool)

# Satelite Surveillance Data
# satellite name (string)
# orbit altitude in km (int)
# camera resolution in megapixels (float)
# is transmitting data (bool)
