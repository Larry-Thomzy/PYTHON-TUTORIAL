...
# Control: You have full control over how data is accessed and modified
 ...
 # Here we Use encapsulation to protect and validate data:
...
# that the property is intended for internal use, but Python doesn't enforce
# this restriction.
...
# methods cannot be called directly from outside the class. The __validate
# method can only be used by other methods inside the class.
...
#
# When you use double underscores __, Python automatically renames it internally
# by adding _ClassName in front.
#
