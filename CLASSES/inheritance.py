...
# inheritance of the parent class, and we are ready
...
# parent element, it will automatically inherit the methods and
...
x = Student7("Burundi", "Kosoko", 2025)
x.welcome()
